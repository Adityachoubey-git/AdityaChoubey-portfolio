...
// Tripling arrays for seamless scroll wrapping
...
export default function MarqueeSection() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Calculate scroll offset: (scrollY - sectionTop + innerHeight) * 0.3
      const currentOffset = (window.scrollY - sectionTop + window.innerHeight) * 0.3;
      
      // Update offset within an animation frame for buttery smooth performance
    ...
    handleScroll(); // Initial run to set positions
      ...
      <div className="flex flex-col gap-3 w-full">
        ...
        <div className="w-full overflow-hidden">
          <div
            ...
            style={{
              transform: `translateX(calc(-20% + ${offset - 200}px))`,
        ...
        <div className="w-full overflow-hidden">
          <div
            className="flex gap-3 transition-transform duration-75 ease-out"
            style={{
              transform: `translateX(calc(-40% - ${offset - 200}px))`,
              willChange: "transform",
            }}
          >
